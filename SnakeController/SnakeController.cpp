...
void Controller::processTimeoutInd()
{
...
void Controller::processDirectionInd(Direction direction)
{
...
void Controller::processFoodInd(FoodInd receivedFood)
{
...
void Controller::processFoodResp(FoodResp requestedFood)
{
    bool requestedFoodCollidedWithSnake = false;
    for (auto const &segment : m_segments)
    {
